    ...
    return (
        <div className="px-5 py-24 md:py-32 lg:py-40 md:px-7 container">
            <div className='flex flex-col lg:flex-row w-full h-fit gap-8'>
                <PropertyGallery className='lg:w-5/12 p-4 rounded-xl border border-gray-200 bg-primary-0' images={images} discount={discount}  thumbnail={thumbnail} isliked={isliked} description={description} id={_id} />
