...
const CampingSupplies = async () => {
    ...
    const text: string = "در رهنورد می‌توانید مجموعه‌ای کامل از لوازم کمپینگ را با کیفیت بالا و قیمت مناسب تهیه کنید. از چادر و چراغ گرفته تا صندلی، میز و ابزارهای کاربردی سفر، همه در یک مجموعه گردآوری شده‌اند تا تجربه‌ای راحت، ایمن و لذت‌بخش در دل طبیعت برای شما فراهم کنند.";

    return (
        <div className=''>
            <div className="bg-campingSupplies-poncho-texture bg-cover bg-center lg: py-16">
                <div className="flex flex-col md:flex-row justify-between gap-y-4 mt-96 container">
                    {/* Page title */}
                    <h3 className="text-Regular-Normal-title-2 md:text-Regular-Subtitle text-primary-0">لوازم کمپینگ</h3>
