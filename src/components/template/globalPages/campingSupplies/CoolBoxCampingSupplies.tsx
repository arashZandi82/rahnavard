...
const CoolBoxCampingSupplies = async () => {
    await connectDB()
    ...
    const text: string = "در رهنورد می‌توانید انواع کول باکس‌ها و یخدان‌های سفری را با کیفیت بالا و طراحی مقاوم تهیه کنید. این کول باکس‌ها با قابلیت حفظ دمای مناسب برای نوشیدنی‌ها و مواد غذایی، انتخابی ایده‌آل برای سفر، کمپینگ و پیک‌نیک هستند تا همیشه از تازگی و طراوت مواد غذایی خود لذت ببرید.";
    
    return (
        <div className=''>
            <div className="bg-campingSupplies-CoolBox-texture bg-cover bg-center lg: py-16">
                <div className="flex flex-col md:flex-row justify-between gap-y-4 mt-96 container">
                    {/* Page title */}
                    <h3 className="text-Regular-Normal-title-2 md:text-Regular-Subtitle text-primary-0">کول باکس</h3>
            ...
            <div className='py-16 md:py-20 lg:py-24 container'>
                ...
                <ShowProducts url='لوازم کمپینگ/کول باکس'/>
            </div>
        </div>
    );
};

export default CoolBoxCampingSupplies;