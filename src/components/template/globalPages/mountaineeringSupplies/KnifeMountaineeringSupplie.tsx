...
const KnifeMountaineeringSupplie = async () => {
    await connectDB()
    ...
    return (
        <div className=''>
            <div className="bg-MountaineeringSupplies-knife-texture bg-cover bg-center lg: py-16">
                <div className="flex flex-col md:flex-row justify-between gap-y-4 mt-96 container">
                    {/* Page title */}
                    <h3 className="text-Regular-Normal-title-2 md:text-Regular-Subtitle text-primary-0">چاقو کوهنوردی</h3>
            ...
            <div className='py-16 md:py-20 lg:py-24 container'>
                ...
                <ShowProducts url='لوازم کوهنوردی/چاقو کوهنوردی'/>
            </div>
        </div>
    );
};

export default KnifeMountaineeringSupplie;